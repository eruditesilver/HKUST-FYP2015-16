var canvas;
  ...
  /*function getNewKnowledgePointId(json){
    var obj = $.parseJSON(json);
    var newKnowledgePointList = obj.GetKnowledgePointListResult;

    console.log("newKnowledgePointList length = " + newKnowledgePointList.length);
  }*/
